            ...
            <div className="container max-w-3xl mx-auto px-4 sm:px-6 md:px-8">
                <div className="mx-0 md:mx-30">
                    ...
                    <div className="prose prose-base sm:prose-lg max-w-none mb-10 md:mb-12 dark:prose-invert">
                        ...
                        <div className="my-6 grid gap-4 grid-cols-1 sm:grid-cols-2">
                            <div className="bg-myanmar-red/5 dark:bg-myanmar-red/10 border border-myanmar-red/30 rounded-lg p-4 sm:p-6">
                            ...
                            <div className="bg-myanmar-green/5 dark:bg-myanmar-green/10 border border-myanmar-green/30 rounded-lg p-4 sm:p-6">
                            ...
                            <div className="bg-myanmar-gold/5 dark:bg-myanmar-gold/10 border border-myanmar-gold/30 rounded-lg p-4 sm:p-6">
                            ...
                            <div className="bg-myanmar-teal/5 dark:bg-myanmar-teal/10 border border-myanmar-teal/30 rounded-lg p-4 sm:p-6">
                            ...
                            <div className="sm:col-span-2 bg-myanmar-maroon/5 dark:bg-myanmar-maroon/10 border border-myanmar-maroon/30 rounded-lg p-4 sm:p-6">
                        ...
                        <div className="mt-10 sm:mt-12 text-center">
                            <Link href="/test" className="inline-block border border-myanmar-red bg-myanmar-red px-6 py-3 rounded-lg shadow hover:bg-myanmar-red/90 transition duration-300 text-white text-base sm:text-lg font-semibold w-full sm:w-auto">
                                Take the Test
                            </Link>
                        </div>
                    </div>
