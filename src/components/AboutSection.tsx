...
export const AboutSection = () => {
    ...
    return (
        <div className={`p-16 ${theme === 'light' ? 'bg-gray-50' : 'bg-gray-900'}`}>
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold mb-4">About the Myanmar Personality Compass</h2>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div className="rounded-lg shadow p-6 border">
                        <h3 className="text-xl font-bold mb-2">The Science</h3>
                    ...
                    <div className="rounded-lg shadow p-6 border md:col-span-2 lg:col-span-1">
