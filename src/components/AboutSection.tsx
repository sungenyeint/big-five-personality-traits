...
export const AboutSection = () => {
    ...
    return (
        <div className={`py-10 px-4 sm:px-6 md:px-10 lg:px-16 ${theme === 'light' ? 'bg-gray-50 text-gray-700' : 'bg-gray-700 text-gray-200'}`}>
            <div className="container mx-auto">
                ...
                <div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div className={`${theme === 'light' ? 'text-gray-700' : 'text-gray-200'} rounded-lg shadow p-6 border`}>
